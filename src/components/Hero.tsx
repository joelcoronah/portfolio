    ...
    <section className="min-h-screen flex items-center pt-20 pb-16">
      <div className="container mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          {/* Photo */}
          <div
            className="order-2 lg:order-1 flex justify-center lg:justify-start animate-fade-up"
          ...
          <div className="order-1 lg:order-2">
            ...
            <p
              className="text-xl text-muted-foreground mb-2 animate-fade-up"
            ...
            <p
              className="text-muted-foreground max-w-lg mb-8 leading-relaxed animate-fade-up"
              style={{ animationDelay: "0.5s" }}
            >
              Crafting elegant digital solutions with 7+ years of experience.
              Passionate about clean code, intuitive UX, and building products
              that matter.
            </p>
